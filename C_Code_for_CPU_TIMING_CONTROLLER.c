...
int main(){
	...
	int control_words[] = {
		...
		1<<PC_OUT|1<<MAR_IN,	1<<PC_INC|1<<MEM_OUT|1<<IR_IN,  1<<SCROLL_IN|1<<REGA_OUT, 	 0,							0,							0,0,0, //OUT 0010
		...
		1<<PC_OUT|1<<MAR_IN,    1<<PC_INC|1<<MEM_OUT|1<<IR_IN,  1<<REGA_OUT|1<<REGB_IN,		 1<<REGA_IN|1<<REGC_OUT, 	1<<REGB_OUT|1<<REGC_IN, 	0,0,0, //SWAP 0111
		1<<PC_OUT|1<<MAR_IN,    1<<PC_INC|1<<MEM_OUT|1<<IR_IN,  1<<PC_LOAD|1<<IR_OUT, 		 0, 						0, 							0,0,0, //JNZ 1000
		1<<PC_OUT|1<<MAR_IN,	1<<PC_INC|1<<MEM_OUT|1<<IR_IN,  1<<IR_OUT|1<<MAR_IN, 		 1<<MEM_IN|1<<REGA_OUT, 	0,							0,0,0, //STA 1001
		1<<PC_OUT|1<<MAR_IN,	1<<PC_INC|1<<MEM_OUT|1<<IR_IN,  1<<IR_OUT|1<<MAR_IN,		 1<<REGA_IN|1<<ALU_OUT,		0,							0,0,0, //LST 1010
		1<<PC_OUT|1<<MAR_IN,	1<<PC_INC|1<<MEM_OUT|1<<IR_IN,  1<<IR_OUT|1<<MAR_IN,		 1<<REGA_IN|1<<ALU_OUT,		0,							0,0,0, //RST 1011
		1<<PC_OUT|1<<MAR_IN,    1<<PC_INC|1<<MEM_OUT|1<<IR_IN,  1<<REGB_IN|1<<REGA_OUT,		 0,							0,							0,0,0, //MAB 1100
		1<<PC_OUT|1<<MAR_IN,    1<<PC_INC|1<<MEM_OUT|1<<IR_IN,  1<<REGA_IN|1<<REGC_OUT,		 0,							0,							0,0,0, //MCA 1101
		1<<PC_OUT|1<<MAR_IN,    1<<PC_INC|1<<MEM_OUT|1<<IR_IN,  1<<REGA_OUT|1<<REGC_IN, 	 0, 						0, 							0,0,0, //MAC 1110
        1<<MAR_IN,   		    1<<MEM_OUT|1<<IR_IN,            0,							 0,							0,							0,0,0, //HLT 1111

	};

	/* 16 instructions, each instruction has 5 T-states. */
